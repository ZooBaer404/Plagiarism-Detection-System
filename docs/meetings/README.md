...
|--------------------|---------------|-----------------|------------------------|----------------------------------------|
| Daily Stand-up     | Daily (15min) | Project Manager | Team, QA Team          | Sync tasks, blockers, quick updates    |
...
| Backend Developer  | Developing servers, databases...                  |
| Frontend Developer | Developing user interface for the website         |
| QA Team            | Maintain quality of the project                   |
