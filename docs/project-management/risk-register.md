...
_Title:_ Skill Shortage
_Closed On:_ <2025-08-10 Sun>
_Reason:_ There might a shortage of technical skill shortage.
...
### RSK-001: Skill Shortage
    Category: Technical
    Description: Staff skill shortage in techinical areas.
    Date Identified: <2025-08-10 Sun>
    Likelihood: High
    Impact: High
    Owner: Backend Team
    Status: Mitigating
    Mitigation Strategy: Setting time aside for staff training.
    Escalation: Not yet
    Notes: Ensure each user's area is known.
